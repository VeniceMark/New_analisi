...
if sezione == "📝 Budget Editor":
    ...
    if uploaded_eff and df_budget is not None:
        try:
            ...
            if 'cliente' in df_eff.columns:
                df_eff = df_eff.set_index('cliente')
            elif df_eff.index.name != 'cliente':
            ...
            styled_dashboard = styled_dashboard.applymap(colori_dashboard, subset=["Scostamento %"])

...
if sezione == "📝 Budget Editor":
    ...
    if uploaded_eff and df_budget is not None:
        try:
            ...
            styled_numeric = diff_numeric.style.applymap(colori_scostamenti).format(format_diff)
            ...
            styled_view = styled_view.format(format_diff, subset=pd.IndexSlice[:, scostamento_cols])
            ...
            dashboard["Scostamento % (str)"] = dashboard["Scostamento %"].apply(format_diff)

# v3.2 - Filtri Anni/Mesi sistemati (UI in sidebar, dentro l'expander dell'anno)
# - Toggle categoria/colonne in sidebar
# - Anni/Mesi: toggles resi *inline* dentro l'expander dell'anno (senza st.columns)
# - Mantiene funzioni di v3.1
...
st.set_page_config(page_title="Analisi Budget vs Effettivo (v3.2)", layout="wide")
st.markdown("### 📊 Analisi Budget vs Effettivo — **v3.2**")
...
def ui_toggle_inline(label: str, value: bool, key: str):
    # Render *dentro* l'expander della sidebar (no st.sidebar.toggle per restare nel contesto)

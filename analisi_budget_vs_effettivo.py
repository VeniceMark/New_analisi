...
if budget_file and effettive_file:
    ...
    styled_cliente = df_dettaglio_cliente.style.applymap(style_dettaglio, subset=df_dettaglio_cliente.columns[1:]).format(formatta_percentuale)
